        ...
        <div className="flex items-center justify-center min-h-screen">
            ...
            <div className="relative flex flex-col m-6 p-4 space-y-3 bg-white shadow-2xl">
                ...
                <div className="flex items-center justify-center border-2 border-black bg-black">
                    <h2 className="font-heading mb-5 text-2xl font-medium text-white">Delete Your Post</h2>
                </div>

                {/* Previous Username */}
                <div>
                    <p className="font-body text-xl">Are you sure you want to delete your post?</p>
                </div>
