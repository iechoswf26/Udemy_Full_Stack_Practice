        ...
        {/*    Card Container*/}
            <form action="" className="relative flex flex-col m-6 p-4 space-y-3 bg-white shadow-2xl">
                ...
                <div className="flex items-center justify-center border-2 border-black bg-black">
                    <h1 className="font-heading mb-5 text-2xl font-medium text-white">Edit Your Username</h1>
                </div>

                {/* Previous Username */}
                <div>
                    <h2 className="font-heading font-semibold text-xl">Current Username</h2>
                ...
                {/* New Username */}
                <div>
                    <label htmlFor="new-username" className="font-heading font-semibold text-xl">New Username</label>
                    <div className="w-full p-1">
                        <input
                            // value={}
                            type="text"
